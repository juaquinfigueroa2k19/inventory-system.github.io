...
$insert = "INSERT INTO log_record (name, activity, timeT, dateT) VALUES ('$name', 'inventory-table', '$timeT', '$dateT')";
echo mysqli_query($conn,$insert);

if (!empty($_SESSION['error_msg-add-ing'])) {
  
  if ($_SESSION['error_msg-add-ing'] == 2) {
    
    echo "<script type='text/javascript'>alert('Success adding product!!');</script>";
    unset($_SESSION['error_msg-add-ing']);
  }
}

$ing = "SELECT * FROM ingredients ORDER BY stocks ASC";
$result = mysqli_query($conn, $ing);
        ...
        <div class="main-panel">
          <div class="content-wrapper"  style="background-image: url('../../assets/images/auth/Login_bg.jpg'); background-size: cover;">
            <div class="page-header">
              <h3 class="page-title">Stocks on-hand</h3>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive" style="height: 700px;">
                      <table class="table table-bordered table-contextual" style="text-decoration-color: white; ">
                        <thead>
                          <tr>
                            <th> Product Name </th>
                            <th> Stocks </th>
                                  ...
                                  if ($ing['stocks'] <= $ing['minimum']) {
                                    echo "<tbody>
                                          <tr>
                                            ...
                                            <td>
                                                <div class='progress'>
                                                  <div class='progress-bar bg-danger' role='progressbar' style='width: ".$ing['stocks']."%' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100'></div>
                                                </div>
                                            </td>
                                          </tr>
                                        </tbody>";

                                  }elseif ($ing['stocks'] >= $ing['maximum']) {
                                    echo "<tbody>
                                          <tr>
                                            <td> ".$ing['product_name']." </td>
                                            <td> ".$ing['stocks']." /".$ing['measure']."</td>
                                            ...
                                            <td>
                                                <div class='progress'>
                                                  <div class='progress-bar bg-warning' role='progressbar' style='width: ".$ing['stocks']."%' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100'></div>
                                                </div>
                                            </td>
                                          </tr>
                                        </tbody>";
                                    ...
                                    echo "<tbody>
                                          <tr>
                                            ...
                                            <td>
                                                <div class='progress'>
                                                  <div class='progress-bar bg-success' role='progressbar' style='width: ".$ing['stocks']."%' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100'></div>
                                                </div>
                                            </td>
                                          </tr>
                                        </tbody>";
