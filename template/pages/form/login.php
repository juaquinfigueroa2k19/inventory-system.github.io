...
if (!empty($_SESSION['error_msg-login'])) {
  
  if ($_SESSION['error_msg-login'] == 1) {
        ...
        <div class="row w-100 m-0">
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <!-- <img src="../../assets/images/favicon.png" style="width: 80px; height: 80px;"> -->
              <div class="card-body px-5 py-5" style="border-radius: 20px;">
